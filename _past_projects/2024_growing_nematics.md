...
I will present published results in a talk at APS Global Summit 2026 in the [DSOFT Emerging Soft Matter Excellence Award Session](https://summit.aps.org/events/MAR-C66/9).
...
<body> 
	<div id="img-container" style="text-align:center;">
        <img src="/assets/nemsub_cartoon.png" alt="Cartoon of alignment mechanism. A spherically symmetric gaussian patch of cells becomes an elongated ellipse due to anisotropic diffusion caused by anisotropic friction." width="500">
    </div>
</body>
Cartoon of alignment mechanism. A spherically symmetric gaussian patch of cells becomes an elongated ellipse due to anisotropic diffusion caused by anisotropic friction. The anisotropic density gradients then lead to realignment of cells in the patch.